...
_container_pull_attrs = {
    ...
    "puller_darwin": attr.label(
        executable = True,
        default = Label("@io_bazel_rules_docker//precompiled/darwin_amd64:puller"),
        cfg = "host",
        doc = "Exposed to provide a way to test other pullers on macOS",
    ),
    "puller_linux_amd64": attr.label(
        executable = True,
        default = Label("@io_bazel_rules_docker//precompiled/linux_amd64:puller"),
        cfg = "host",
        doc = "Exposed to provide a way to test other pullers on Linux",
    ),
    "puller_linux_arm64": attr.label(
        executable = True,
        default = Label("@io_bazel_rules_docker//precompiled/linux_arm64:puller"),
        cfg = "host",
        doc = "Exposed to provide a way to test other pullers on Linux",
    ),
    "puller_linux_s390x": attr.label(
        executable = True,
        default = Label("@io_bazel_rules_docker//precompiled/linux_s390x:puller"),
        cfg = "host",
        doc = "Exposed to provide a way to test other pullers on Linux",
    ),
