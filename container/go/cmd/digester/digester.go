...
var (
	...
	legacyBaseImage = flag.String("legacyBaseImage", "", "Optional: the path to a legacy base image in tarball form.")
	configPath      = flag.String("configPath", "", "Optional: the path to the image config for legacy format.")
