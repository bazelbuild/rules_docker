  ...
  def test_py_image_complex(self):
    with TestImage('py_image_complex') as img:
      ...
      self.assertTopLayerContains(img, [
        ...
        './app/testdata/py_image_complex.binary.runfiles/container_pip_deps_pypi__addict_2_1_2/__init__.py',
        ...
        './app/testdata/py_image_complex.binary.runfiles/container_pip_deps_pypi__six_1_11_0/__init__.py',
        './app/io_bazel_rules_docker',
        '/app',
        '/app/testdata',
      ...
      self.assertLayerNContains(img, 5, [
        ...
        '/app/testdata/py_image_complex.binary.runfiles/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info/WHEEL',
        '/app/testdata/py_image_complex.binary.runfiles/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info/metadata.json',
        '/app/testdata/py_image_complex.binary.runfiles/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info/top_level.txt',
      ])
      ...
      self.assertLayerNContains(img, 6, [
        '.',
        './app',
        './app/container_pip_deps_pypi__six_1_11_0',
        './app/container_pip_deps_pypi__six_1_11_0/six.py',
        './app/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info',
        './app/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info/DESCRIPTION.rst',
        './app/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info/METADATA',
        './app/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info/RECORD',
        './app/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info/WHEEL',
        './app/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info/metadata.json',
        './app/container_pip_deps_pypi__six_1_11_0/six-1.11.0.dist-info/top_level.txt',
      ])
      ...
      self.assertLayerNContains(img, 8, [
        '.',
        './app',
        './app/container_pip_deps_pypi__addict_2_1_2',
        './app/container_pip_deps_pypi__addict_2_1_2/addict',
        './app/container_pip_deps_pypi__addict_2_1_2/addict/__init__.py',
        './app/container_pip_deps_pypi__addict_2_1_2/addict/addict.py',
        './app/container_pip_deps_pypi__addict_2_1_2/addict-2.1.2.dist-info',
        './app/container_pip_deps_pypi__addict_2_1_2/addict-2.1.2.dist-info/DESCRIPTION.rst',
        './app/container_pip_deps_pypi__addict_2_1_2/addict-2.1.2.dist-info/METADATA',
        './app/container_pip_deps_pypi__addict_2_1_2/addict-2.1.2.dist-info/RECORD',
        './app/container_pip_deps_pypi__addict_2_1_2/addict-2.1.2.dist-info/WHEEL',
        './app/container_pip_deps_pypi__addict_2_1_2/addict-2.1.2.dist-info/metadata.json',
        './app/container_pip_deps_pypi__addict_2_1_2/addict-2.1.2.dist-info/top_level.txt',
      ])
