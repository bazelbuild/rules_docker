...
To get the correct digest one can run `docker manifest inspect gcr.io/my-project/my-base:tag` once [experimental docker cli featuer are enabled](https://docs.docker.com/engine/reference/commandline/manifest_inspect).
