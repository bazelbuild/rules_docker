...
container_pull(
    name = "test_pull_files_in_layer_with_files_base",
    registry = "localhost:5000",
    # STAMP_VALUE is the expanded version of the {TEST_STAMP} bazel
    # stamp variable generated by print-workspace-status.sh during the e2e
    # tests.
    repository = "docker/test/stamp_value",
    tag = "stamp_value",
)
